...
public enum WrongUsageType {
    ARGS_FEW("Not enough arguments!"),
    ARGS_AMNT("Wrong amount of arguments!"),
    WRONG_SUB("No such sub-command!"),
    LONG_NAME("That team name is too long!"),
    TEAM_EXISTS("That team already exists!"),
    NO_TEAM("There is no such team!"),
